...
| Endpoint | Method | Auth | Request | Returns (example) |
|---|---|---|---|---|
| `/chat/sessions/` | GET | Yes | _(none)_ | `[ { "id": 1, "title": "Gift ideas", "recipient_id": 2, "budget": "100.00", "event_type": "birthday", "is_self_gift": false, "stranger_description": "", "created_at": "2026-06-19T10:00:00Z", "updated_at": "2026-06-19T10:00:00Z" } ]` |
| `/chat/sessions/` | POST | Yes | body: `title`, `recipient_id`, `budget`, `event_type`, `is_self_gift` (`false`), `stranger_description` — must supply at least one of `recipient_id` / `stranger_description` / `is_self_gift=true` | `{ "id": 1, "title": "Gift ideas", "recipient_id": 2, "budget": "100.00", "event_type": "birthday", "is_self_gift": false, "stranger_description": "", "messages": [], "created_at": "…", "updated_at": "…" }` |
| `/chat/sessions/<id>/` | GET | Yes | path **`id`** | `{ "id": 1, "title": "Gift ideas", "recipient_id": 2, "budget": "100.00", "event_type": "birthday", "is_self_gift": false, "stranger_description": "", "messages": [ { "id": 1, "role": "user", "content": "Hi", "metadata": {}, "created_at": "…" }, { "id": 2, "role": "assistant", "content": "Hello!", "metadata": {}, "created_at": "…" } ], "created_at": "…", "updated_at": "…" }` |
| `/chat/sessions/<id>/messages/` | POST | Yes | path **`id`**; body: **`content`**, `mentioned_user_ids` `[ids]` | **SSE** stream of `data: {"text": "..."}` chunks, terminated by `data: [DONE]`. Returns `503` if the Anthropic API key is not configured. |
