...
// Flashy CTA at the top of a profile. Routes to the gift-finder, carrying
// recipient context in router state (gift-finder consumes it when built).
const CreateGiftButton = ({ isOwner, recipientId, recipientName }) => {
  ...
  const handleClick = () =>
    navigate('/gift-finder', {
      state: isOwner ? { isSelfGift: true } : { recipientId, recipientName },
    });
